...
class ProductosController < ApplicationController
  ...
  def index
    render json: Producto.all, status: :ok
  end
  ...
  def update
    respond_to do |format|
      if @producto.update(producto_params)
        format.html { redirect_to @producto, notice: "Producto editado correctamente." }
  ...
  private
    ...
    def producto_params
      params.require(:producto).permit(:nombre, :stock, :precio, :descripcion)
    end
end
end
end
